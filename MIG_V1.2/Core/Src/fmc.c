...
void MX_FMC_Init(void)
{
  ...
  */
  ...
  void SDRAM_Initialization_Sequence(SDRAM_HandleTypeDef *hsdram1)
  {
      ...
      HAL_Delay(1);  // Step 2: Insert delay of at least 100µs
      ...
      Command.ModeRegisterDefinition = 10;
      ...
      // Step 6: Set the refresh rate (depends on SDRAM device)
      HAL_SDRAM_ProgramRefreshRate(hsdram1, 7031);  // Adjust for 64ms/8192 rows
  }
